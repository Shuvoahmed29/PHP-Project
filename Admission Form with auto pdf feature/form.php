...
<div class="mb-3 row">
   <div class="col-sm-4">
    ...
    <div class="mb-3 row">
   <div class="col-sm-4">
      <label class="lable">Faculty:- </label>
    </div>
     <div class="col-sm-8">
     <select name="category"  class="form-control" required>
      <option value="">Select your Faculty</option>
		...
		<option value="Life and Earth Science">Life and Earth Science</option>
     </select>
    </div>
    </div>
<div class="mb-3 row">
   ...
   <div class="col-sm-4">
     ...
     <select name="course" class="form-control" required>
      <option value="">Select Department</option>
        ...
        <option value="Electrical, Electronic and Communication Engineering">Electrical, Electronic and Communication Engineering</option>
...
<script>
 ...
 I declare that I have read and filled the 
I confirm that the information I have submitted is accurate to the best of my knowledge. In the event that any discrepancies are discovered, I understand and agree that you retain the right to cancel without notifying me in advance. information, so if the information given by me is incorrect, you have the right to cancel without informing me.
    </div>
