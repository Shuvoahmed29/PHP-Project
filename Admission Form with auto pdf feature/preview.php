...
<div class="row">
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="https://www.pust.ac.bd/includes/images/forms/pust_logo.jpg" class="img-fluid">
          </div>
           <div class="col">
              <div class="main-heading">পাবনা বিজ্ঞান ও প্রযুক্তি বিশ্ববিদ্যালয়</div>
		 <p class="sub-heading" style="text-align: center">Pabna University of Science and Technology -PUST</p>
		 <div class="address"style="text-align: center">Rajapur, Pabna-6600,Bangladesh</div>
         <p class="email">Website: www.pust.ac.bd, E-mail: registraroffice@pust.ac.bd</p>
          </div>
          <div class="col-sm-12">
            <hr class="hrcls"> 
          </div>
  ...
  <div class="col-sm-8" style="text-align: center;padding-bottom: 5px;">
   <h3> <u>Student Registration form 2023</u></h3>
  </div>
  <div class="col-sm-2">
  </div>
...
<div class="form-group row">
  ...
  <div class="row">
    <div class="col-6">
     <div class="form-group row">
   <div class="col-4">
      <label class="lable">Admission Fees</label>
    </div>
     <div class="col-8">
    <?php echo $row['course_fees']; ?> Taka  
    </div>
    </div>
    </div>
    <div class="col-6">
